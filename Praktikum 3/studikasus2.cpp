...
ostream& operator << (ostream& output, const Biaya& data) {
	...
	if(data.menu == 1){
		cout<<"Ayam Geprek\t"<< data.harga << "\t\t" << data.jumlah << "\t\t" << data.jarak << "\t\t" << data.ongkir << "\t\t" << -data.diskon << "\t\t" << data.total <<endl;
	}
    else if(data.menu == 2){
		cout<<"Ayam Goreng\t"<< data.harga << "\t\t" << data.jumlah << "\t\t" << data.jarak << "\t\t"  << data.ongkir << "\t\t" << -data.diskon << "\t\t" << data.total << endl;
	}
    else if(data.menu == 3){
		cout<<"Udang Goren\t"<< data.harga << "\t\t" << data.jumlah << "\t\t" << data.jarak << "\t\t" << data.ongkir << "\t\t" << -data.diskon << "\t\t" << data.total <<endl;
	}
    else if(data.menu == 4){
		cout<<"Cumi Goreng\t"<< data.harga << "\t\t" << data.jumlah << "\t\t" << data.jarak << "\t\t" << data.ongkir << "\t\t" << -data.diskon << "\t\t" << data.total << endl;
	}
    else if(data.menu == 5){
		cout<<"Ayam Bakar\t"<< data.harga << "\t\t" << data.jumlah << "\t\t" << data.jarak << "\t\t" << data.ongkir << "\t\t" << -data.diskon << "\t\t" << data.total << endl;
	}
